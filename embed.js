...
function r0({ editor: n }) {
  ...
  return u("div", {
    ref: e,
    id: dc(n.id),
    class: "mention-suggestions" + (i !== null ? " active" : ""), //hereee
    children: t
      ? u(W, { padding: 10, size: "small" })
      : h.length
      ? h.map((p, m) =>
...
function Y0({ notification: n, onRead: e, onClose: t }) {
  ...
  return u("a", {
    ...
    onClick: (clickEvent) => {
        ...
        window.location.href = n.comment_url;
    },
    href: n.comment_url,
    target: "_blank",
    children: [
        ...
        D.callPageApi({
          ...
          success: (o) => {
            fr(i, o.comment),
              ...
              basePageUrl = 'discuss.html?id=' + o.comment.page_id,
              t(!1);
          },
          error: () => {
